...
class _CountScreenState extends State<CountScreen> {
  ...
  List<String> images = [
    'assets/images/counter/bg6.jpg',
    'assets/images/counter/bg2.jpg',
    'assets/images/counter/bg3.jpg',
    'assets/images/counter/bg4.jpg',
    'assets/images/counter/bg7.jpg',
  ];
                ...
                children: [
                  Positioned.fill(
                    child: GestureDetector(
                      onTap: toggleCount,
                      child: Image.asset(
                        'assets/images/counter/bg1.jpg', // Use the first image
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
